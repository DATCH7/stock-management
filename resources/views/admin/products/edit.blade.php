                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantity_in_stock" id="quantity_in_stock" value="{{ old('quantity_in_stock', $product->quantity_in_stock) }}" required
                                min="0"
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Note: For major stock adjustments, consider using stock entry/exit forms instead.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-amber-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Price changes will affect all future transactions but not existing ones</li>
                                <li>Stock quantity changes here are direct adjustments - use stock movements for proper tracking</li>
                                <li>Changing the product name may affect how staff recognize this item</li>
                                <li>Category changes will affect filtering and organization in the system</li>
                            </ul>
                        </div>
                    </div>
                </div>
